...
.data
ScrollFont		LOGFONT <12,8,0,0,FW_DONTCARE,0,0,0,DEFAULT_CHARSET,OUT_DEFAULT_PRECIS,CLIP_DEFAULT_PRECIS,\
									DEFAULT_QUALITY	,0,'Terminal'>
ScrollText	    		db	"PERYFERiAH tEAM PrEsEnT : Maxidix Wifi Suite 15.9.2 Build 890 - Keygenned, GFX'ed and coded by r0ger                                        "
						db  "MSX : Wayfinder , Protection : SHA-1 + BASE64                                                                          "
						db  "GreetZ 2 all of the PRF members including Al0hA,GRUiA,B@TRyNU,sabYn,"
						db  "s0r3l,DAViD,ShTEFY,MaryNello,zzLaTaNN , plus the whole tSRh.ws , exe"
						db  "tools , trainingcircle.in , tuts4you.org and revteam.online communit"
						db  "ies , and fuckingz 2 Carlos and Rajan Kamur - da spammer & shit eate"
						db  "r + all the lamerz & ripperz who were tryin' to fuck with us  .                   ",0
...
ScrollerInit proc hWnd:HWND
	...
	m2m scr.scroll_hwnd,hWnd
		...
		mov scr.scroll_x,1
		mov scr.scroll_y,244
		
		mov scr.scroll_width,347
